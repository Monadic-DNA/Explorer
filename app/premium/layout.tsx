...
export const metadata: Metadata = {
  ...
  description: "Unlock advanced AI-powered genetic analysis with LLM Chat, Run All analysis, and comprehensive overview reports. Privacy-preserving analysis with Trusted Execution Environment.",
